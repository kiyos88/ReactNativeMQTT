...
public class PahoExampleActivity extends AppCompatActivity {
    ...
    final String publishMessage = "{'Kidus': 'Solomon'}";
        ...
        try {
            ...
            mqttAndroidClient.connect(mqttConnectOptions, null, new IMqttActionListener() {
                ...
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    addToHistory("Failed to connect to: " + serverUri + " " + exception.getMessage());
    ...
    private void addToHistory(String mainText) {
        Log.d(PahoExampleActivity.class.getSimpleName(), "LOG: " + mainText);
    }
